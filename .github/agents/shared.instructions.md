---
description: "Shared rules for all agents in the Power BI to Visual Gallery migration project. USE FOR: enforcing project-wide constraints, coding standards, and safety rules."
---

# Shared Project Rules — Power BI to Visual Gallery Migration
...
```
Power BI source → [src] → Visual Gallery
```
