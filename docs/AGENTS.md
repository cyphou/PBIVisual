# Multi-Agent Architecture — Power BI to Visual Gallery Migration
...
| **@extractor** | Parsing Power BI source artifacts | `src/` extraction modules |
...
| **Formula Correctness** | Valid syntax, correct conversion from Power BI formulas |
